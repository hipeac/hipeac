...
class MembershipRequest(FilesMixin, models.Model):
    """
    ...
    user = models.ForeignKey(
        get_user_model(), related_name="membership_requests", null=True, blank=True, on_delete=models.SET_NULL
    )
    ...
    membership_type = models.CharField(
        db_index=True, max_length=16, null=True, blank=True, choices=MEMBERSHIP_TYPE_CHOICES
    )
