...
class Member(KeywordsMixin, models.Model):
    ...
    advisor = models.ForeignKey(get_user_model(), related_name="_affiliates", on_delete=models.DO_NOTHING, null=True)
    institution = models.ForeignKey(Institution, related_name="_i1", on_delete=models.DO_NOTHING, null=True)
    second_institution = models.ForeignKey(Institution, related_name="_i2", on_delete=models.DO_NOTHING, null=True)
