...
class Internship(models.Model):
    ...
    institution = models.ForeignKey('hipeac.Institution', related_name='internships', null=True,
    ...
    created_by = models.ForeignKey('auth.User', related_name='posted_phd_internships', null=True, blank=True,
                                   on_delete=models.SET_NULL)
