...
Vue.component('dblp-icon', {
    template: '' +
        '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="dblp"><path class="fillit" d="M21.3 14.58l-2.45-9.16s-.15-.59-.72-.33l-5.6 2.6.86 3.2 1.09 4.08.01.06c.05.47-.41.79-.41.79l-1.88.87.5 1.89.04.1c.07.17.28.6.81.91l6.95 4.27s.68.41.52-.17l-1.98-7.4 1.86-.86s.56-.26.4-.85zm-7.54.09l-.01-.06-1.13-4.22-.66-2.45-.67-2.49v-.04s-.16-.59-.84-1L3.5.14s-.68-.41-.52.17l1.99 7.42-1.87.87s-.56.26-.4.85l2.45 9.16s.16.59.72.33l6.17-2.87 1.3-.61s.52-.24.42-.79z"/></svg>' +
    ''
});

Vue.component('github-icon', {
    template: '' +
        '<svg xmlns="http://www.w3.org/2000/svg" class="github" viewBox="0 0 180.442 175.988"><defs><clipPath id="a"><path d="M0 140.868h595v560.264H0z"/></clipPath></defs><g fill="#1b1817" clip-path="url(#a)" transform="matrix(1.33333 0 0 -1.33333 -433.6 925.213)"><path class="fillit" fill-rule="evenodd" d="M392.867 693.91c-37.366 0-67.666-30.294-67.666-67.666 0-29.897 19.388-55.261 46.274-64.209 3.382-.626 4.623 1.468 4.623 3.255 0 1.614-.063 6.944-.092 12.598-18.824-4.093-22.797 7.984-22.797 7.984-3.078 7.821-7.513 9.901-7.513 9.901-6.14 4.2.463 4.114.463 4.114 6.795-.478 10.373-6.973 10.373-6.973 6.035-10.345 15.83-7.354 19.69-5.625.608 4.373 2.362 7.358 4.297 9.048-15.03 1.71-30.83 7.513-30.83 33.44 0 7.388 2.644 13.425 6.973 18.163-.703 1.705-3.02 8.587.655 17.908 0 0 5.682 1.818 18.613-6.936 5.398 1.499 11.186 2.25 16.937 2.276 5.75-.025 11.544-.777 16.951-2.276 12.916 8.754 18.59 6.936 18.59 6.936 3.683-9.321 1.366-16.203.663-17.908 4.339-4.738 6.964-10.775 6.964-18.162 0-25.99-15.83-31.712-30.897-33.387 2.427-2.1 4.59-6.218 4.59-12.531 0-9.054-.079-16.341-.079-18.57 0-1.8 1.218-3.91 4.648-3.246 26.871 8.958 46.235 34.313 46.235 64.2 0 37.371-30.295 67.666-67.665 67.666"></path><path d="M350.83 596.756c-.15-.336-.679-.437-1.16-.206-.491.22-.767.679-.608 1.016.146.346.676.443 1.165.21.492-.22.773-.683.602-1.02M353.57 593.699c-.323-.3-.953-.16-1.381.313-.443.471-.526 1.102-.199 1.406.333.3.945.159 1.389-.313.442-.477.528-1.103.191-1.406M356.238 589.802c-.415-.288-1.093-.018-1.512.584-.414.601-.414 1.323.01 1.612.42.29 1.088.03 1.512-.568.414-.612.414-1.333-.01-1.628M359.893 586.037c-.37-.41-1.16-.3-1.739.259-.592.545-.756 1.32-.384 1.729.375.41 1.17.294 1.752-.26.587-.544.767-1.324.371-1.728M364.936 583.85c-.164-.53-.925-.77-1.691-.545-.766.232-1.266.853-1.112 1.388.16.534.924.785 1.696.544.764-.231 1.266-.847 1.107-1.386M370.473 583.445c.02-.558-.63-1.02-1.435-1.03-.81-.019-1.464.433-1.473.982 0 .564.636 1.022 1.445 1.035.804.016 1.463-.432 1.463-.987M375.627 584.322c.096-.544-.463-1.103-1.262-1.252-.786-.144-1.513.192-1.613.732-.097.559.472 1.118 1.257 1.262.8.14 1.516-.188 1.618-.741"></path></g></svg>' +
    ''
});
...
Vue.component('linkedin-icon', {
    ...
    template: '' +
        '<svg focusable="false" cxmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24"  class="linkedin"><path class="fillit" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path></svg>' +
    ''
});
...
Vue.component('twitter-icon', {
    ...
    template: '' +
        '<svg focusable="false" xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" class="twitter"><path class="fillit" d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"></path></svg>' +
    ''
});

Vue.component('youtube-icon', {
    template: '' +
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 727.222 512.361" class="youtube"><defs><clipPath id="a"><path d="M0 123.5h595v595H0z"/></clipPath></defs><g clip-path="url(#a)" transform="matrix(1.33333 0 0 -1.33333 -33.057 817.515)"><path class="fillit" d="M297.5 613.136s-170.556 0-213.09-11.472c-23.47-6.314-41.95-24.914-48.224-48.534C24.793 510.32 24.793 421 24.793 421s0-89.319 11.393-132.134c6.273-23.617 24.757-42.217 48.225-48.533 42.534-11.47 213.09-11.469 213.09-11.469s170.556 0 213.086 11.47c23.472 6.315 41.953 24.915 48.225 48.532C570.21 331.681 570.21 421 570.21 421s0 89.32-11.398 132.13c-6.272 23.621-24.753 42.22-48.225 48.534-42.53 11.472-213.086 11.472-213.086 11.472zm-55.78-111.04l142.55-81.1-142.55-81.092v162.192z"/></g></svg>' +
    ''
});
...
Vue.component('website-icon', {
    props: ['type'],
    template: '' +
        '<youtube-icon v-if="type == \'youtube\'"></youtube-icon>' +
        '<twitter-icon v-else-if="type == \'twitter\'"></twitter-icon>' +
        '<linkedin-icon v-else-if="type == \'linkedin\'"></linkedin-icon>' +
        '<github-icon v-else-if="type == \'github\'"></github-icon>' +
