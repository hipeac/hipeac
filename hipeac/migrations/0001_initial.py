...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "page block", "ordering": ["page", "key"]},
        ),
        migrations.CreateModel(
            name="Break",
            fields=[
            ...
            options={"db_table": "hipeac_event_break", "ordering": ["date", "start_at"]},
        ),
        migrations.CreateModel(
            name="Clipping",
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={"db_table": "hipeac_event_fee"},
        ),
        migrations.CreateModel(
            name="Image",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.FileField(
                        blank=True, null=True, upload_to=hipeac.functions.get_images_path, verbose_name="Logo"
                    ),
                ),
                (
                    "application_areas",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "programme",
                    models.CharField(blank=True, choices=[("FP7", "FP7"), ("H2020", "H2020")], max_length=5, null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            options={"db_table": "hipeac_publicity_email"},
        ),
        migrations.CreateModel(
            name="Quote",
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={"ordering": ["sponsorship_type", "-amount", "institution__name"]},
        ),
        migrations.CreateModel(
            name="Track",
            fields=[
                ...
                (
                    "event",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="tracks", to="hipeac.Event"
                    ),
                ),
            ],
            options={"db_table": "hipeac_event_track"},
        ),
        migrations.CreateModel(
            name="Venue",
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="logs", to="hipeac.Session"
            ),
        ),
        migrations.AddField(
