...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('early', 'Early'), ('late', 'Late'), ('early_student', 'Early (student)'), ('late_student', 'Late (student)'), ('booth', 'Booth fee')], editable=False, max_length=16)),
                ('value', models.PositiveIntegerField(default=0, validators=[django.core.validators.MinValueValidator(1)])),
                ('notes', models.CharField(blank=True, max_length=190, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('gender', 'Gender'), ('title', 'Title'), ('meal_preference', 'Meal preference'), ('job_position', 'Position'), ('employment_type', 'Employment type'), ('application_area', 'Application area'), ('session_type', 'Session type'), ('topic', 'Topic')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fee_type', models.CharField(choices=[('regular', 'Regular'), ('student', 'Student')], default='regular', max_length=8)),
                ...
                ('paid_via_invoice', models.PositiveSmallIntegerField(default=0, verbose_name='Amount paid via invoice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_speaker', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='talks', to=settings.AUTH_USER_MODEL)),
                ('projects', models.ManyToManyField(blank=True, related_name='sessions', to='hipeac.Project')),
                ('session_type', models.ForeignKey(limit_choices_to={'type': 'session_type'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='session_type', to='hipeac.Metadata')),
            ],
            options={
